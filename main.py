...
def display_picture(im,screen):
        """Display image on PyGame screen."""
        pg_img = pygame.image.frombuffer(im, (100,100),'RGB')
        screen.blit(pg_img, (0,0))
        pygame.display.flip()
def eval_genomes(genomes, config):
    global game_speed, x_pos_bg, y_pos_bg, points, obstacles, dinosaurs, ge, nets, finalScore, winner
    ...
    def statistics():
        global dinosaurs, game_speed, ge,winner
        text_1 = FONT.render(f'Dinosaurs Alive: {str(len(dinosaurs))}',True,(0,0,0))
        text_2 = FONT.render(f'Generation: {pop.generation+1}',True,(0,0,0))
        text_3 = FONT.render(f'Game Speed: {str(game_speed)}',True,(0,0,0))
        text_4 = FONT.render(f'Top Score: {str(finalScore)}',True,(0,0,0))
